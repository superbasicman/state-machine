...
/**
 * Custom error for workflow pause (interaction needed)
 */
...
export class WorkflowRuntime {
  constructor(workflowDir) {
    ...
    this._pendingInteraction = savedState._pendingInteraction || null;
  ...
  persist() {
    const state = {
      ...
      _pendingInteraction: this._pendingInteraction,
      _error: this._error,
  ...
  showStatus() {
    ...
    if (this._pendingInteraction) {
      console.log(`\nPending Interaction:`);
      console.log(`  File: interactions/${this._pendingInteraction.file}`);
      console.log(`  Target: ${this._pendingInteraction.targetKey}`);
    }
